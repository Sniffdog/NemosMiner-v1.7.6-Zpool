...
SET GPUccminer=0,1
SET GPUequihash=0 1 
SET A=ccminerAlexisx86.exe
SET B=ccminerTpruvot2.2.4.exe
SET C=ccminerKlaus8.19.exe
SET D=ccminerkrnlx86.exe
SET E=miner.exe
...
%B% -d %GPUccminer% -r 0 -a %A17% -o stratum+tcp://%POOL%:3553 -u %ADDY% -p %PASS% -i 23
REM %A% -d %GPUccminer% -r 0 -a %A18% -o stratum+tcp://%POOL%:3334 -u %ADDY% -p %PASS% 
%A% -d %GPUccminer% -r 0 -a %A19% -o stratum+tcp://%POOL%:3555 -u %ADDY% -p %PASS% 
%B% -d %GPUccminer% -r 0 -a %A20% -o stratum+tcp://%POOL%:5034 -u %ADDY% -p %PASS% -i 24
%B% -d %GPUccminer% -r 0 -a %A21% -o stratum+tcp://%POOL%:3556 -u %ADDY% -p %PASS% 
%D% -d %GPUccminer% -r 0 -a %A22% -o stratum+tcp://%POOL%:3747 -u %ADDY% -p %PASS%
ECHO Starting SniffDog if this helped you please donate #Sniff....
GOTO start